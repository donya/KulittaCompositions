...
> module JazzFG where
> import GrammarMonad hiding (c)
> import GrammarRules
> import GrammarRulesV
...
> jazzFG1T :: StdGen -> Key -> Term CType -> Constraints -> (StdGen, Music Pitch)
> jazzFG1T g (k,m) t consts = jazzFG1 g (ctTrans k $ toChords (expand [] t) m) consts
...
> jazzFG2T :: StdGen -> Key -> Term CType -> Constraints ->  (StdGen, Music (Pitch, Volume))
> jazzFG2T g (k,m) t consts = jazzFG2 g (ctTrans k $ toChords (expand [] t) m) consts
