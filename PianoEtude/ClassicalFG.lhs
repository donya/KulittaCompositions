...
> classicalFG :: StdGen -> Key -> Term CType -> (StdGen, (Music Pitch, Music Pitch))
> classicalFG g (k,m) t = 
...
> classicalFGR :: StdGen -> Key -> [RChord] -> Constraints -> (StdGen, (Music Pitch, Music Pitch))
...
> classicalCS g (k,m) rcs consts = 
>     classicalCS2 g (k,m) (atTrans k $ map toAbsChord rcs) consts 
