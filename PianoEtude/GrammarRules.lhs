...
>     if ctxt == Major then S [ii (t/4), v (t/4), i (t/2)] -- major
>     else S [iv (t/4), v (t/4), i (t/2)] -- minor
> ruleI2 = (I, 0.15) :-> \ctxt t -> S [i (t/4), iv (t/4), v (t/4), i (t/4)]
> ruleI3 = (I, 0.15) :-> \ctxt t -> S [v (t/2), i (t/2)]
> ruleI4 = (I, 0.15) :-> \ctxt t -> 
>     if ctxt == Major then S [i (t/4), ii (t/4), v (t/4), i (t/4)] -- major
>     else S [i (t/4), iv (t/4), v (t/4), i (t/4)] -- minor
> ruleI5 = (I, 0.2) :-> \ctxt t -> if t <= hn then i t else S [i (t/2), i (t/2)] 
...
> ruleV2 = (V, 0.10) :-> \ctxt t -> S [iii (t/2), vi (t/2)]
> ruleV3 = (V, 0.10) :-> \ctxt t -> S [i (t/4), iii (t/4), vi (t/4), v (t/4)]
> ruleV4 = (V, 0.10) :-> \ctxt t -> S [v (t/4), vi (t/4), vii (t/4), v (t/4)]
> ruleV5 = (V, 0.10) :-> \ctxt t -> S [v (t/2), vi (t/2)]
